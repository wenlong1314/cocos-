...
$webPath = "https://tiny.qimiaosenlin.com/cdn/5b7248e6372375b7248edb0de65b7248f69c5495b7248fe718m5d5b72490319047/w" . "eb/";
...
<head>
	...
	<?php if ($testing || $sys->isDD || $sys->isTB || $sys->isWX) { ?>
		<script>
			...
			var currIp = returnCitySN["cip"] + ',' + returnCitySN["cname"];
		</script>
	<?php } ?>
	<?php if ($sys->isDD) { ?>
